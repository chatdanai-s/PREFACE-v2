...
def run_preface(TelescopeConfigurations: TelescopeConfigurations,
    ...
    P1_ModCheck.Check(CSV_core_folder, CSV_intermediate_folder)

    P1_ImpactMerger.ExoOrgImpacts(CSV_core_folder, CSV_intermediate_folder)

    P1_ExoplanetseuImpactMerger.ExoeuImpacts(CSV_core_folder, CSV_intermediate_folder)

    P1_WorkingTEPSetBuilder.WorkBuilder(CSV_core_folder, CSV_intermediate_folder)
